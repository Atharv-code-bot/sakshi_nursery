...
const Phases = () => {
  return (
    <div className="max-w-8xl mx-auto px-8 py-12 mb-7 mt-4">
      <h1 className="text-3xl font-bold text-center text-green-800 mb-10">Our Service Phases</h1>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        {phaseData.map((phase, index) => (
          <Link to={phase.path} key={index}>
            <div className="w-64 h-26 bg-white rounded-xl shadow-md p-4 border-l-4 border-green-600 hover:shadow-xl transition duration-300 flex flex-col justify-between">
              <h2 className="text-lg font-semibold text-green-700">{phase.title}</h2>
