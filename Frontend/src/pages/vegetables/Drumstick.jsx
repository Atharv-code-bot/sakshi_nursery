...
const drumstickVarieties = [
  {
    name: 'ODC',
    description:
      'ODC (Ongole Drumstick Clone) is a high-yielding, perennial variety known for its long, tender pods with excellent taste and nutrition. Adaptable to various soil types and climatic conditions.',
    price: 130,
    available: 30,
    images: [
      'https://shivaruthraexports.com/wp-content/uploads/2021/10/drumstick-gallery8.jpg',
      'https://5.imimg.com/data5/SELLER/Default/2020/9/MN/NJ/CE/1245251/vegetable-drumstick-500x500.jpg',
      'https://t3.ftcdn.net/jpg/02/49/56/48/360_F_249564840_ldDS5cSXABNZdltTKTWfdmpPvuzxumtW.jpg',
    ],
  },
];
          ...
          <section className="flex flex-col md:flex-row items-center gap-8 mb-10 max-w-5xl mx-auto">
            ...
            <div className="md:w-1/2 text-gray-700 text-lg">
              <p className="text-justify">
                Drumstick, also known as Moringa pod, is a long, slender green vegetable known for its earthy flavor and numerous health benefits. It is a rich source of vitamins A, C, and B-complex, along with calcium, iron, and powerful antioxidants that support bone health, immunity, and digestion. Native to the Indian subcontinent, drumstick is widely grown in tropical and subtropical regions and thrives in warm climates. Both the pods and leaves of the moringa tree are used in traditional dishes. Commonly added to curries, dals, soups, and stews, drumstick is a nutritious and flavorful ingredient cherished in many cuisines for its medicinal and culinary value.
              </p>
            </div>
          </section>

          <h2 className="text-2xl font-semibold mb-6 text-green-700 text-center">
            We have these drumstick varieties
          </h2>

          <section className="grid grid-cols-1 sm:grid-cols-1 gap-6 px-4 sm:px-0 max-w-lg mx-auto mb-8">
            {drumstickVarieties.map((variety, index) => (
              <article
                key={index}
